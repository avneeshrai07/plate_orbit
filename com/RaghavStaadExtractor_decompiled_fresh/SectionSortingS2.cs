// ===== RaghavStaadExtractor.SectionSortingS2 =====
...
public void SummerizedToSheet2()
{
	checked
	{
		try
		{
			...
			List<object[]> list2 = list.OrderBy((object[] r) => Convert.ToString(RuntimeHelpers.GetObjectValue(r[0]))).ToList();
			...
			for (int l = 0; l <= num9; l++)
			{
				...
				do
				{
					array2[l, num10] = RuntimeHelpers.GetObjectValue(list2[l][num10]);
					num10++;
				}
				while (num10 <= 3);
			}
